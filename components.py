...
material_basic_floor.diffuse = bk.Color(0.5, 0.5, 0.5)
...
class SkyscraperFloorLeft(bk.Mesh):
    ...
    def __init__(self, w=1, h=1, m=material_darker):
        ...
        self.w = w
        self.h = h
        self.name = "SkyscraperFloor2Mesh2"
        # self.materials = materials
        self.positions = [
            [-w, 0, -h / 2],
            [w, 0, -h / 2],
...
class BasicRectangleWall(bk.Mesh):
    """
    ...
    def __init__(self, w=1, h=1, m=material_stone_bricks):
       ...
       # Calculate the hexagon's side length from the distance between opposite sides (w)
        ...
        positions = [
            [-hex_side_length / 2, -h / 2, 0],  # Bottom-left corner
            [hex_side_length / 2, -h / 2, 0],   # Bottom-right corner
            [hex_side_length / 2, h / 2, 0],    # Top-right corner
            [-hex_side_length / 2, h / 2, 0]    # Top-left corner
        ]
...
class BasicRectangleWindowWall(bk.Mesh):
    def __new__(cls, *args, **kwargs):
        return super().__new__(cls)
    ...
    def __init__(self, w=1, h=1):
        ...
        self.w = w
        self.h = h
        self.name = "BasicRectangleWindowWallMesh"
        # self.materials = materials
        hex_side_length =  w / 2  # Formula for hexagon side length
        self.positions = [
            [-hex_side_length/2, -h/2, 0.0], [hex_side_length/2, -h/2, 0.0], [hex_side_length/2, h/2, 0.0], [-hex_side_length/2, h/2, 0.0],
            [-hex_side_length*0.2, -h*0.2, 0.0], [hex_side_length*0.2, -h*0.2, 0.0], [hex_side_length*0.2, h*0.2, 0.0], [-hex_side_length*0.2, h*0.2, 0.0],
            [-hex_side_length*0.2, -h*0.2, 0.0], [hex_side_length*0.2, -h*0.2, 0.0], [hex_side_length*0.2, h*0.2, 0.0], [-hex_side_length*0.2, h*0.2, 0.0],
        ]
        self.triangles = [
            [0, 1, 5], [0, 5, 4], [1, 2, 6], [1, 6, 5], [2, 3, 7], [2, 7, 6], [3, 0, 4], [3, 4, 7],
