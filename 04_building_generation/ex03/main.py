...
skyscraper = MySkyscraperDubaiCorner(app, 14, 6)
skyscraper.building.set_transform(Mat4.from_translation(Vec3(-4, 0, -4)))
skyscraper2 = MySkyscraperDubaiLeft(app, 46, 2)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 0)))
skyscraper3 = MySkyscraperDubaiRight(app, 44, 2)
skyscraper3.building.set_transform(Mat4.from_translation(Vec3(0, 0, -3)))
skyscraper4 = MySkyscraperDubaiLeft(app, 40, 2)
skyscraper4.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 2)))
skyscraper5 = MySkyscraperDubaiRight(app, 38, 2)
skyscraper5.building.set_transform(Mat4.from_translation(Vec3(2, 0, -3)))
skyscraper6 = MySkyscraperDubaiLeft(app, 34, 2)
skyscraper6.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 4)))
skyscraper7 = MySkyscraperDubaiRight(app, 32, 2)
skyscraper7.building.set_transform(Mat4.from_translation(Vec3(4, 0, -3)))
skyscraper8 = MySkyscraperDubaiLeft(app, 28, 2)
skyscraper8.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 6)))
skyscraper9 = MySkyscraperDubaiRight(app, 24, 2)
skyscraper9.building.set_transform(Mat4.from_translation(Vec3(6, 0, -3)))
skyscraper10 = MySkyscraperDubaiLeft(app, 22, 2)
skyscraper10.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 8)))
skyscraper11 = MySkyscraperDubaiRight(app, 18, 2)
skyscraper11.building.set_transform(Mat4.from_translation(Vec3(8, 0, -3)))
skyscraper12 = MySkyscraperDubaiLeft(app, 15, 2)
skyscraper12.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 10)))
skyscraper13 = MySkyscraperDubaiRight(app, 11, 2)
skyscraper13.building.set_transform(Mat4.from_translation(Vec3(10, 0, -3)))
skyscraper14 = MySkyscraperDubaiLeft(app, 9, 2)
skyscraper14.building.set_transform(Mat4.from_translation(Vec3(-3, 0, 12)))
skyscraper15 = MySkyscraperDubaiRight(app, 6, 2)
skyscraper15.building.set_transform(Mat4.from_translation(Vec3(12, 0, -3)))
skyscraper = MySkyscraperDubaiCorner(app, 1, 6)
skyscraper.building.set_transform(Mat4.from_translation(Vec3(2, 0, 2)))

'''
skyscraper2 = MySkyscraper(app, 15, 3)
skyscraper2.building.set_transform(Mat4.identity())
skyscraper2 = MySkyscraper(app, 14, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(0, 0, 3)))
skyscraper2 = MySkyscraper(app, 14, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(3, 0, 0)))
skyscraper2 = MySkyscraper(app, 13, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(0, 0, 6)))
skyscraper2 = MySkyscraper(app, 13, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(6, 0, 0)))
skyscraper2 = MySkyscraper(app, 13, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(3, 0, 3)))
'''
