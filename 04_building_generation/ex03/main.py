...
skyscraper1 = MySkyscraperRandom(app, 10, 8)
skyscraper1.building.set_transform(Mat4.from_translation(Vec3(-10, 0, 0)))
skyscraper1 = MySkyscraperGroundFloor(app, 1, 8)
skyscraper1.building.set_transform(Mat4.from_translation(Vec3(-10, 0, 0)))
...
skyscraper2 = MySkyscraperGroundFloor(app, 1, 3)
skyscraper2.building.set_transform(Mat4.identity())
skyscraper2 = MySkyscraperGroundFloor(app, 1, 3)
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(0, 0, 3)))
skyscraper2 = MySkyscraperGroundFloor(app, 1, 3)
...
skyscraper2.building.set_transform(Mat4.from_translation(Vec3(3, 0, 3)))
'''
highrise = MySkyscraper(app, 100, 3)
